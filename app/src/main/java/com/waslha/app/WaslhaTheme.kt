...
private val WaslhaSurfaceLow = Color(0xFFFBFDFC)
private val WaslhaSurfaceHigh = Color(0xFFF0F4F2)
...
private val LightWaslhaColors = lightColorScheme(
    ...
    surfaceDim = Color(0xFFD7DEDA),
    surfaceBright = Color(0xFFFFFFFF),
    surfaceContainerLowest = Color.White,
    surfaceContainerLow = WaslhaSurfaceLow,
    surfaceContainer = WaslhaSurfaceAlt,
    surfaceContainerHigh = WaslhaSurfaceHigh,
    ...
    inverseSurface = WaslhaInk,
    inverseOnSurface = Color.White,
    inversePrimary = WaslhaLime,
    error = WaslhaError,
...
private val DarkWaslhaColors = darkColorScheme(
    ...
    surfaceBright = Color(0xFF303833),
    ...
    outlineVariant = Color(0xFF2C3631),
    inverseSurface = Color(0xFFE7EEE9),
    inverseOnSurface = Color(0xFF1A211E),
    inversePrimary = WaslhaEmeraldDark,
